...
SW(config-pmap-c)#police 100000000 10000 exceed-action drop
```
Tạo policy-map kết hợp với class-map, cấu hình để tăng giảm băng thông, 100000000: Băng thông giới hạn bps, 10000: Tốc độ burst Bytes
